...
export const EmailComposer = forwardRef<EmailComposerHandle, EmailComposerProps>(
  function EmailComposer(
    { content, initialDocument, onDocumentChange, onReadyChange },
    forwardedRef,
  ) {
